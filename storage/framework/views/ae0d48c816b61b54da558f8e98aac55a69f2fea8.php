                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" placeholder="Caption" data-bs-original-title="" id="name" required value="<?php echo e(@$page->name); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="form-label">Page SLUG</label>
                                    <input class="form-control" type="text" placeholder="Caption" data-bs-original-title="" id="slug" required readonly value="<?php echo e(@$page->slug); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Page Caption</label>
                                    <input class="form-control" type="text" placeholder="Caption" data-bs-original-title="" id="title" required value="<?php echo e(@$page->title); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" placeholder="description" data-bs-original-title="" id="description"  value="<?php echo e(@$page->description); ?>">
                                </div>
                            </div>
                            <div class="col-md-12">
                                    <div class="mb-3">
                            ...
                            <div class="col-sm-6 col-md-2 p-2">
                                <div class="mb-3 border border-right p-2">
                                    ...
                                    <div class="icon-state switch-outline ">
                                        <label class="switch">
                                            <input type="checkbox" <?php if(!empty($page->status)): ?> checked="" <?php endif; ?> data-bs-original-title="" title="" id="page_status"><span class="switch-state  bg-success shadow-sm"></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="border table-responsive">
                                    <table class="table resourceTable">
                                        ...
                                        <tbody class="resource_body">
                                            <?php $__currentLoopData = array_keys($page->items->groupBy("model")->toArray()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
                                                        ...
                                                        <table class="table itemtable">
                                                            ...
                                                            <tbody class="itemBody">
                                                               <?php ($ids = 0); ?>                                                               
                                                                <?php $__currentLoopData = $page->items->where("model",$model); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                                              
                            ...
                            <div class="col-sm-12 col-md-12 mt-2 border-top pt-3">
                                <div class="mb-3">
                                    <button type="button" class="btn btn-sm btn-primary" id="createPage"><i class="fa fa-arrow-up"></i> <?php if(isset($page)): ?>Update <?php else: ?> Create <?php endif; ?> section</button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminpanel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\subra\Documents\projects\kedarCollection\resources\views/adminpanel/pages/editPage.blade.php ENDPATH**/ ?>