...
class googlePay extends paymentInterface{
  initiatePayment(){
      console.log("Payment initiated... for GOOGLEPAY")
  }
}
/**
...
const baseRequest = {
    ...
     */
    const allowedCardNetworks = ["AMEX", "DISCOVER", "JCB", "MASTERCARD", "VISA", "RUPAY"];
...
<script async  src="https://pay.google.com/gp/p/js/pay.js"  onload="onGooglePayLoaded()"></script><?php /**PATH C:\Users\subra\Documents\projects\kedarCollection\resources\views/userpanel/js/googlePay.blade.php ENDPATH**/ ?>