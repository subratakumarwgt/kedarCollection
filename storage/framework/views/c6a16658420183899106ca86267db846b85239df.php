<div class="col-md-10">
    <table class="p-3  table table-stripe">
        ...
        <tr>
            <td><?php echo e($item->quantity); ?> x <?php echo e($item->product->name ??  @$item->item->name); ?></td>
...
</div><?php /**PATH C:\Users\subra\Documents\projects\kedarCollection\resources\views/adminpanel/expenses/components/order_details.blade.php ENDPATH**/ ?>