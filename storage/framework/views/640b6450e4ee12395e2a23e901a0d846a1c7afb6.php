...
<input type="hidden" id="section_id" value="<?php echo e(@$section->id); ?>">

<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            <h4 class="bg-white text-primary p-3  rounded"><?php if(isset($section)): ?>Update <?php else: ?> Add <?php endif; ?> Section</h4>
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" placeholder="Caption" data-bs-original-title="" id="name" required value="<?php echo e(@$section->name); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="form-label">Section SLUG</label>
                                    <input class="form-control" type="text" placeholder="Caption" data-bs-original-title="" id="slug" required readonly value="<?php echo e(@$section->slug); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Section Caption</label>
                                    <input class="form-control" type="text" placeholder="Caption" data-bs-original-title="" id="title" required value="<?php echo e(@$section->title); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" placeholder="Sub Caption" data-bs-original-title="" id="sub_title" required value="<?php echo e(@$section->sub_title); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-2 p-2">
                                <div class="mb-3 border border-right p-2">
                                    ...
                                    <div class="icon-state switch-outline ">
                                        <label class="switch">
                                            <input type="checkbox" <?php if(!empty($section->status)): ?> checked="" <?php endif; ?> data-bs-original-title="" title="" id="section_status"><span class="switch-state  bg-success shadow-sm"></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4 p-2">
                                <div class="mb-3 border border-right p-2">
                                    ...
                                    <input type="text" title="" id="redirect_url" class="form-control"  value="<?php echo e(@$section->redirect_url); ?>">
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-3 p-2">
                                <div class="mb-3 border border-right p-2">
                                    <label for=""><strong>Redirect TEXT</strong> </label>
                                    <input type="text" title="" id="redirect_text" class="form-control" value="<?php echo e(@$section->redirect_text); ?>">
                                </div>
                                ...
                                <div class="border table-responsive">
                                    <table class="table resourceTable">
                                        ...
                                        <tbody class="resource_body">
                                            <?php if(empty(array_keys($section->items->groupBy("model")->toArray()))): ?>
...
<?php endif; ?>
                                        ...
                                        <table class="table itemtable">
                                            ...
                                            <?php endif; ?>  
                                            <?php $__currentLoopData = array_keys($section->items->groupBy("model")->toArray()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
                                                            <select name="" class="form-control select_resource" style="width: 300px;" id="">
                                                                ...
                                                                <option value="<?php echo e($elem); ?>" <?php if($elem == $model): ?> selected <?php endif; ?>><?php echo e($elem); ?></option>
                                                        ...
                                                        <table class="table itemtable">
                                                            ...
                                                            <tbody class="itemBody">
                                                               <?php ($ids = 0); ?>
                                                                ...
                                                                <?php $__currentLoopData = $section->items->where("model",$model); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                                              
                                                                <tr class="itemTableRow">
                                                                    <td>
                                                                        <select name="" id="" class="item_id m-1 form-control">
                                                                            <option value="0">Select a Item</option>
                                                                            ...
                                                                            <?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $el): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <option value="<?php echo e($el->id); ?>" <?php if($row->model_id ==$el->id ): ?> selected <?php endif; ?>><?php echo e($el->name); ?></option>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        </select>
                                                                    </td>
                                                                    <td>
                                                                        <div class="text-center text-end icon-state switch-outline switch-sm m-1 ">
                                                                            <label class="switch">
                                                                                <input type="checkbox" <?php if(!empty($item->status)): ?>checked <?php endif; ?> data-bs-original-title="" title="" class="item_status" id=""><span class="switch-state  bg-success shadow-sm"></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                    <td class="text-center">
                            ...
                            <div class="col-sm-12 col-md-12 mt-2 border-top pt-3">
                                <div class="mb-3">
                                    <button type="button" class="btn btn-sm btn-primary" id="createSection"><i class="fa fa-arrow-up"></i> <?php if(isset($section)): ?>Update <?php else: ?> Create <?php endif; ?> section</button>
...
<script>
    ...
    let images = []
    images[0] = {
        image:"<?php echo e($section->background_image); ?>",
        status: "1"
    } 
    let  background_image ;
    background_image = "<?php echo e($section->background_image); ?>" 
    let section = {}
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminpanel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\subra\Documents\projects\kedarCollection\resources\views/adminpanel/sections/editSection.blade.php ENDPATH**/ ?>