                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" placeholder="Name" data-bs-original-title="" id="name" required value="<?php echo e(@$emailTemplate->name); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="" id="text-box-body" class="form-control" rows="6" value="<?php echo e(@$emailTemplate->body); ?>"><?php echo e(@$emailTemplate->body); ?></textarea>
                                    </div>
                                </div>
...
<script>
    ...
    $("#createEmail").on("click",function(e){
        ...
        form.append("id",$("#emailTemplate_id").val())
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminpanel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\subra\Documents\projects\kedarCollection\resources\views/adminpanel/templates/editEmailTemplate.blade.php ENDPATH**/ ?>