...
<div class="col-md-12 pl-5">
    <ul class="mb-3" id="order_details">
        ...
        <li class="p-1 border-bottom">
           <?php echo e($item->quantity); ?> x <?php echo e($item->product->name ?? @$item->item->name); ?> <strong class="pull-right mr-5">₹ <?php echo e($item->subtotal); ?></strong>
        </li>
 ...
 minutes > 1 ? $("#readyMessage").html(`We still have ${minutes} minutes left.`) : ""
  ...
  if (distance < 0) {
    ...
    $("#time_left").html(`Please ready order ASAP !`)
        ...
        <?php elseif($order->current_status == 'order_ready'): ?>
...
<div class="container">
    ...
    <div class="col-9 p-2">
            <div class="p-2">
                <ul class="list m-1 p-1">
                    <?php $__currentLoopData = $order->orderDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><?php echo e($item->quantity); ?> x <?php echo e($item->product->name ?? @$item->item->name); ?></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
        </div>
    ...
    <div class="col-md-7">
          ...
          <div class="col-md-5">
          <button class="btn  readyOrder btn-success text-right" data-order_id="<?php echo e($order->order_id); ?>" onclick="packOrder(event,this)"><i class="fa fa-check-circle"></i> Order packed & handed over to Courier service</button>
          </div> 
    </div>
    </div>
</div>
...
<?php endif; ?>
<?php /**PATH C:\Users\subra\Documents\projects\kedarCollection\resources\views/adminpanel/expenses/components/order_info.blade.php ENDPATH**/ ?>