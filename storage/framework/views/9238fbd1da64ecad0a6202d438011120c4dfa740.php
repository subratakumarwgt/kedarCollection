...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                <div class="col-md-12 mb-3"><div class="pull-right"><a href="<?php echo e(route('collection-import')); ?>" class="btn btn-primary btn-sm mr-3"><i class="fas fa-plus-square"></i> New Collection</a></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminpanel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\subra\Documents\projects\kedarCollection\resources\views/adminpanel/collections/collectionList.blade.php ENDPATH**/ ?>