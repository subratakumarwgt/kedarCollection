   ...
   <div class="modal fade product_modal" id="exampleModalCenter_<?php echo e($product->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenter_<?php echo e($product->id); ?>" aria-hidden="true">
                  ...
                  <div class="row">
                     <div class="col-md-5 product_view_left p-1" data-wow-duration=".8s">
                        <div class="product_view_large">
                           <img src="/<?php echo e($product->image); ?>" class="img-fluid" width="100%"/>
                        </div>
   ...
   <?php if($onOffer): ?>
    <div class="discount_tag"><?php echo e(@$offer->detail->value); ?><?php if($offer->detail->type == 2): ?>% <?php else: ?> <i class="fa fa-inr"></i> <?php endif; ?> OFF</div>
   <?php endif; ?>
      <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModalCenter_<?php echo e($product->id); ?>">
         <img src="/<?php echo e($product->image); ?>" class="img-fluid prod-image">
      </a>
      <div class="ts_item_text">
         <div class="tsp_name product_title pt-0 m-0">
         <a href="<?php echo e(route('shop-by-items',['id' => $product->id])); ?>"  <span class="h5 "><?php echo e($product->name); ?></span>         
           <div class="addcart-btn mb-2   pull-right">
            <?php if($product->quantities->count() == 0): ?>
            <button class="add-to-cart btn btn-primary" data-quantity="<?php echo e($product->id); ?>" data-product="<?php echo e($product->id); ?>" id="addBtn_<?php echo e($product->id); ?>"> Add
             <a href="#" class=" ml-1 text-dark" ><i class="fa fa-plus-circle"></i></a>
            </button>   
            <?php else: ?>   
            <button class="btn btn-danger"  data-bs-toggle="modal" data-bs-target="#exampleModalCenter_<?php echo e($product->id); ?>" data-quantity="<?php echo e($product->id); ?>" data-product="<?php echo e($product->id); ?>" id="addBtn_<?php echo e($product->id); ?>"> Options
             <i class="fa fa-eye"></i>
            </button>
            <?php endif; ?>    
            </div> <br>
            <div class="text-secondary  font-calps" style="max-height: 1.7rem !important;overflow:hidden; "><?php echo e($product->description); ?>  </div>
            <h6 class="m-0 p-1 pull-left text-primary " style="max-height: 1.7rem !important;overflow:hidden; "><?php if($product->quantities->count() > 0): ?>From <?php endif; ?><i class="fa fa-inr small"></i> <?php echo e($onOffer ? $product->offer_price : $product->price); ?>

            <?php if($onOffer): ?> <del class="text-danger"><small><i class="fa fa-inr small"></i> <?php echo e($product->price); ?> </small> </del> <?php endif; ?>
         </h5>
         </div>        
...
<?php /**PATH C:\Users\subra\Documents\projects\kedarCollection\resources\views/components/product.blade.php ENDPATH**/ ?>