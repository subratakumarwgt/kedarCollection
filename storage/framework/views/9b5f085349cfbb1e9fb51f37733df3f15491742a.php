...
<div class="container-fluid">
    <div class="card">
                <div class="card-body">
                <div class="row"><div class="col-md-9 pull-left"><h4  class="bg-white text-primary p-3  rounded">Add Collection</h4></div>  <div class="col-md-3 pull-right"><a href="<?php echo e(route('collection-list')); ?>" class="btn btn-primary btn-sm mr-3"><i class="fas fa-list"></i> Collection list</a></div></div>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" placeholder="Name" data-bs-original-title="" id="name" required value="<?php echo e(@$collection->name); ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Collection Caption</label>
                                        <input class="form-control" type="text" placeholder="Caption" data-bs-original-title="" id="caption" required value="<?php echo e(@$collection->title); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" placeholder="Sub Caption" data-bs-original-title="" id="sub_caption" required value="<?php echo e(@$collection->sub_title); ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-5 p-2">
                                    <div class="mb-3 border border-right p-2" id="banner_holder">
                                        ...
                                        <table class="table">
                                            <tbody>
                                            <?php $__currentLoopData = $collection->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                                                                  
                                                <tr>
                                    ...
                                    <div class="mb-3  p-2 border">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody class="productBody">
                                                <?php if(isset($collection)): ?>
                                                <?php $__currentLoopData = $collection->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $productE): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($key == 0): ?>
                                                <tr>
                                                    <td>
                                                        <select name="" id="" class="product_id m-1 form-control" >
                                                            ...
                                                            <option value="<?php echo e($product->id); ?>" <?php if($productE->product_id == $product->id): ?>selected <?php endif; ?>><?php echo e($product->title); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </td>
                                                    <td>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    ...
                                    <div class="icon-state switch-outline m-1 ">
                                        <label class="switch">
                                            <input type="checkbox" <?php if(isset($collection) && $collection->status == "1"): ?> checked="" <?php endif; ?> data-bs-original-title="" title="" id="collection_status"><span class="switch-state  bg-success shadow-sm"></span>
                                        </label>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminpanel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\subra\Documents\projects\kedarCollection\resources\views/adminpanel/collections/collectionEdit.blade.php ENDPATH**/ ?>