                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" placeholder="Sub Caption" data-bs-original-title="" id="sub_title" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-2 p-2">
                                  <div class="mb-3 border border-right p-2" >
                                    ...
                                    <div class="icon-state switch-outline ">
                                        <label class="switch">
                                            <input type="checkbox" checked="" data-bs-original-title="" title="" id="section_status"><span class="switch-state  bg-success shadow-sm"></span>
                                        </label>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-sm-6 col-md-4 p-2">
                                  <div class="mb-3 border border-right p-2" >
                                    <label for=""><strong>Redirect URL</strong> </label>
                                            ...
                                            <input type="text"  title="" id="redirect_url" class="form-control" value="<?php echo e(env('APP_URL')); ?>pages/">
                                ...
                                <div class="col-sm-6 col-md-3 p-2">
                                  <div class="mb-3 border border-right p-2" >
                                    <label for=""><strong>Redirect TEXT</strong> </label>
                                            ...
                                            <input type="text"  title="" id="redirect_text" class="form-control">
...
$("#createSection").on("click",function(event) {
       ...
       { 
        ...
        section.background_image = images[0].image
        ...
        $(this).prop("disabled",false)
            ...
            $.post("/api/section/save",section,function(response){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminpanel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\subra\Documents\projects\kedarCollection\resources\views/adminpanel/sections/addSection.blade.php ENDPATH**/ ?>