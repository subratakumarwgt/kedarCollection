      ...
      <form action="" id="add_item_form" onsubmit="return confirmOrder(event,this)">
        ...
        <div class="modal-body">
          ...
          <label for="view_type">
            ...
            <div id="order_details_row" class="mb-2">

            </div>
            <label for="view_type">
              Preparation time ( Days)
              <p>
               <small>(Time needed for handover the order package to courier service)</small>
              </p> 
            </label>
            <input type="number" class="form-control" id="prep_time" required name="prep_time" value="3">            
          </div>
        </div>
      ...
      <form action="" id="add_item_form" onsubmit="return readyOrder(event,this)">
        ...
        <div class="modal-body">
          <div class="form-group p-1 mt-2">
           ...
           <small class="text-danger">( This action can not be undone )</small>
            <input type="hidden" id="order_id" value="">
          </div>
        </div>
        <div class="modal-footer">
        ...
        <div class="col-md-4 pl-5 pt-4 border-right">
            <div class="text-center text-primary">
                ...
                <div class="col-md-12 p-1">
                    ...
                    <input class="form-check-input order_type" type="radio" name="inlineRadioOptions" id="inlineRadio_<?php echo e($type); ?>" value="<?php echo e($type); ?>" >
                    <label class="form-check-label" for="inlineRadio_<?php echo e($type); ?>"><?php echo e($type); ?></label>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminpanel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\subra\Documents\projects\kedarCollection\resources\views/adminpanel/expenses/onlineOrders.blade.php ENDPATH**/ ?>