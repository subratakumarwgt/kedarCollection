                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" placeholder="Caption" data-bs-original-title="" id="name" required value="<?php echo e(@$offer->name); ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Offer Caption</label>
                                        <input class="form-control" type="text" placeholder="Caption" data-bs-original-title="" id="caption" required value="<?php echo e(@$offer->title); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" placeholder="Sub Caption" data-bs-original-title="" id="sub_caption" required value="<?php echo e(@$offer->sub_title); ?>">
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-3 border border-right p-2" id="banner_holder">
                                        ...
                                        <table class="table">
                                            ...
                                            <?php $__currentLoopData = $offer->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                                                                  
                                                <tr>
                                                    <td class=""><img src="/<?php echo e($image->image); ?>" alt="" class="img-thumbnail exist_image" data-image = "<?php echo e($image->image); ?>" width="60px"></td>
                                                    <td><a href="/<?php echo e($image->image); ?>" class="link a m-1" target="blank" ><i class="fa fa-image"></i> View image</a></td>
                                                    <td> <div class="text-center text-end icon-state switch-sm switch-outline m-1 ">
                                                            <label class="switch">
                                                                <input type="checkbox" class="image_status" <?php if($image->status == "1"): ?>checked <?php endif; ?> data-bs-original-title="" title="" id=""><span class="switch-state  bg-success shadow-sm"></span>
                                                            </label>
                                                        </div>
                                                    </td>
                                ...
                                <div class="col-sm-7 col-md-7 p-2 borer-left justify-content-center">
                                    <div class="mb-3  p-2 border">
                                        ...
                                        <table class="table">
											...
											<?php if(isset($offer)): ?>
                                                <?php $__currentLoopData = $offer->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $productE): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($key == 0): ?>
                                                <tr>
                                                    <td>
                                                        <select name="" id="" class="product_id m-1 form-control" >
                                                            ...
                                                            <option value="<?php echo e($product->id); ?>" <?php if($productE->product_id == $product->id): ?>selected <?php endif; ?>><?php echo e($product->name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <div class="text-center text-end icon-state switch-outline switch-sm m-1 ">
                                                            <label class="switch">
                                                                <input type="checkbox" class="product_status" id=""  <?php if($productE->status == "1"): ?>checked <?php endif; ?> data-bs-original-title="" title="" ><span class="switch-state  bg-success shadow-sm"></span>
                                                            </label>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-center text-end icon-state switch-outline switch-sm m-1 ">
                                                            <label class="switch">
                                                                <input type="checkbox" <?php if($productE->status == "1"): ?>checked <?php endif; ?> data-bs-original-title="" title="" class="product_status" id=""><span class="switch-state  bg-success shadow-sm"></span>
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    ...
                                    <div class="icon-state switch-outline m-1 ">
                                        <label class="switch">
                                            <input type="checkbox" <?php if(isset($offer) && $offer->status != "0"): ?> checked="" <?php endif; ?> data-bs-original-title="" title="" id="offer_status"><span class="switch-state  bg-success shadow-sm"></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="" id="offer_type" class="offer_type m-1 form-control" >
                                             ...
                                             <option value="<?php echo e($key+1); ?>" <?php if(isset($offer) && !empty($offer->detail) && $offer->detail->type == ($key+1)): ?> selected <?php endif; ?>"><?php echo e($type); ?></option>
                                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="" id="offer_value" class="form-control" value="<?php if(isset($offer) && !empty($offer->detail)): ?><?php echo e($offer->detail->value); ?><?php else: ?> 5 <?php endif; ?>">
                                    </div>
                                </div>
...
$("#createOffer").on("click",function(event) {
       ...
       { 
        ...
        .then((data)=>{
            ...
            images = offer_has_images.concat(existImages)
        if(images.length == 0)
       { 
        $.notify({
        ...
        $(this).prop("disabled",false)
         ...
         $.post("/api/offer/edit/"+$("#offer_id").val(),offer,function(response){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminpanel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\subra\Documents\projects\kedarCollection\resources\views/adminpanel/offers/offerEdit.blade.php ENDPATH**/ ?>