                                    ...
                                    <div class="col-sm-6 col-md-12">
                                        ...
                                        <div class="col-sm-6 col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" placeholder="Address Landmark " data-bs-original-title="" title="" id="country" value="{{@$user->address->country}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-3">
                                            <div class="mb-3">
                                                <label class="form-label">State </label>
                                                <input class="form-control" type="text" placeholder="Address Landmark " data-bs-original-title="" title="" id="state" value="{{@$user->address->state}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-3">
                                            <div class="mb-3">
                                                <label class="form-label">District </label>
                                                <input class="form-control" type="text" placeholder="Address Landmark " data-bs-original-title="" title="" id="district" value="{{@$user->address->district}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-3">
                                            <div class="mb-3">
