    ...
    <div class="col-md-10 bg-white shadow-sm p-4 mb-4 mt-5 rounded  ">
        ...
        <div class="row pl-3 pr-3 wish-list mt-3">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="pt-4 col-md-12">
                            ...
                            <p class="mb-0 text-secondary"> {{date("H:i, d M",strtotime("+4 days"))}} - {{date("H:i, d M",strtotime("+5 days"))}}</p>
                        </div>
            ...
            <div class="col-md-8 order-md-1">
                ...
                <div class="container-fluid @if(Auth::check() && !empty(Auth::User()->address)) d-none  @else  @endif " id="formDetails">
                <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="firstName">Full name</label>
                            <input type="text" class="form-control" id="user_name" placeholder="Your full name" value="{{strtoupper(@Auth::User()->name)}}" required="">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-6 col-md-5">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" placeholder="Address Landmark" data-bs-original-title="" required title="" id="landmark" value="{{@$user->address->landmark}}">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" placeholder="Shipping Country" data-bs-original-title="" required title="" id="country" value="{{@$user->address->country}}">   
                                <div class="invalid-feedback">
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" placeholder="Shipping State" data-bs-original-title="" required title="" id="state" value="{{@$user->address->state}}">  
                                <div class="invalid-feedback">
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" placeholder="Shipping District" data-bs-original-title="" required title="" id="district" value="{{@$user->address->district}}">   
                                <div class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="zip" placeholder="Enter Your PIN to qualify for Service" placeholder="" required="" value="{{@Auth::User()->pin}}">
                ...
                <div class="container-fluid  @if(Auth::check() && !empty(Auth::User()->address)) @else d-none @endif" id="savedDetails">
                    <div class="row">
                        <div class="col-md-12">
                         ...
                         <div class="col-md-12">
                            <ul class="list-group">
                                <li class="list-group-item">
                                    <span>Name:</span>
                                    <span class="pull-right" id="savedName">{{@Auth::User()->name ?? ""}}</span>
                                </li>
                                <li class="list-group-item">
                                    <span>Email:</span>
                                    <span class="pull-right" id="savedEmail">{{@Auth::User()->email ?? ""}}</span>
                                </li>
                                <li class="list-group-item">
                                    <span>Mobile Number:</span>
                                    <span class="pull-right" id="savedContact">{{@Auth::User()->contact ?? ""}}</span>
                                </li>
                            </ul>
                            </div>
                    </div>
                        ...
                        <h6>Address Details <span class="pull-right badge badge-outline-success badge-light text-dark shadow-sm showForm"><i class="fa fa-pencil"></i></span></h6>
                         ...
                         <div class="col-md-12">
                            <ul class="list-group">
                                <li class="list-group-item">                                   
                                    <span >
                                        <p id="savedAddress">{{!empty($address) ? $address->address_line_1 . ", " . $address->address_line_2 . ", ". $address->landmark.", ".$address->district.", ".$address->zip_code : "" }}</p>                                                                             
                                    </span>
                                </li>
...
@endsection
@section("script")
<script src="{{asset('/js/paymentInterface.js')}}"></script>
@include("userpanel.js.googlePay")
@include("userpanel.js.razorPay")
<script>
    ...
    const placeOrder = async () => {       
            ...
            form.append("user_address", fullAddress);
