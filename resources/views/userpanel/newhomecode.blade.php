...
<html lang="en">
  <head>
    ...
    <title>{{Config::get('settings.brand.brand_name')}}</title>
    <!-- Google font-->
  ...
  .banner{
    background: url("{{asset('assets/images/banner/7.png')}}");
  ...
  <body>
    <div class="landing-page">
        <section class="banner">            
            ...
            <header>                       
              <nav class="navbar navbar-b navbar-dark navbar-expand-xl  nav-padding" id="sidebar-menu"><a class="navbar-brand p-1" href="#"><img class="img-fluid" src="{{asset('assets/images/logo/logo.png')}}" alt="" width="40px"></a>
        ...
        <div class="col-md-5 pt-4 mt-5">
            <div class="row justify-content-center mt-4">
                <div class="col-6  mt-4 pull-right ">
                    <img src="{{asset('assets/images/banner/1.jpg')}}" alt="" height="380px" width="280px" class="navbar-x">
                </div>
        ...
        <div class="container">
          <div class="landing-center ptb50">
            ...
            <div class="footer-content">
              <h5>Copyright (c) {{Config::get('settings.brand.brand_name')}} {{date("Y")}} all rights reserved</h5>
             </div>
          </div>
        </div>
      </footer>
