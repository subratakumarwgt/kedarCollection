...
<div class="container-fluid">
    <div class="card">
                <div class="card-body">
                <div class="row"><div class="col-md-9 pull-left"><h4  class="bg-white text-primary p-3  rounded">Add Collection</h4></div>  <div class="col-md-3 pull-right"><a href="{{route('collection-import')}}" class="btn btn-primary btn-sm mr-3"><i class="fas fa-plus-square"></i> New Collection</a></div></div>
