...
<div class="container-fluid">
    <div class="card">
                <div class="card-body">
                <h4  class="bg-white text-primary p-3  rounded">@if(isset($offer))Update @else Add @endif Offer</h4>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" placeholder="Caption" data-bs-original-title="" id="name" required value="{{@$offer->name}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Offer Caption</label>
                                        <input class="form-control" type="text" placeholder="Caption" data-bs-original-title="" id="caption" required value="{{@$offer->title}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" placeholder="Sub Caption" data-bs-original-title="" id="sub_caption" required value="{{@$offer->sub_title}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-7 col-md-7 p-2 borer-left justify-content-center">
                                    <div class="mb-3  p-2 border">
                                        ...
                                        <table class="table">
											...
											@if(isset($offer))
                                                @foreach($offer->products as $key => $productE)
                                                @if($key == 0)
                                                <tr>
                                                    <td>
                                                        <select name="" id="" class="product_id m-1 form-control" >
                                                            ...
                                                            <option value="{{$product->id}}" @if($productE->product_id == $product->id)selected @endif>{{$product->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </td>
                                                    <td>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="" id="schedule" class="form-control" min="{{date('Y-m-d')}}" value="@if(isset($offer)){{date("Y-m-d",strtotime($offer->start_date))}}@else{{date("Y-m-d")}}@endif">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">Expiry <small>(Show upto)</small></label>
                                        <input type="date" name="" id="expiry" class="form-control" min="{{date('Y-m-d')}}" value="@if(isset($offer)){{date("Y-m-d",strtotime($offer->end_date))}}@else{{date("Y-m-d")}}@endif">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    ...
                                    <div class="icon-state switch-outline m-1 ">
                                        <label class="switch">
                                            <input type="checkbox" @if(isset($offer) && $offer->status != "0") checked="" @endif data-bs-original-title="" title="" id="offer_status"><span class="switch-state  bg-success shadow-sm"></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="" id="offer_type" class="offer_type m-1 form-control" >
                                             ...
                                             <option value="{{$key+1}}" @if(isset($offer) && !empty($offer->detail) && $offer->detail->type == ($key+1)) selected @endif">{{$type}}</option>
                                             @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="" id="offer_value" class="form-control" value="@if(isset($offer) && !empty($offer->detail)){{$offer->detail->value}}@else 5 @endif">
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-12 mt-2 border-top pt-3">
                                    <div class="mb-3">
                                       <button type="button" class="btn btn-sm btn-primary" id="createOffer"><i class="fa fa-arrow-up"></i> @if(isset($offer))Update @else Create @endif offer</button>
