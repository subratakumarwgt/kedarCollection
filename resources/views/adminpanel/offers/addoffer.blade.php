                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="" id="offer_type" class="offer_type m-1 form-control" >
                                             ...
                                             <option value="{{$key+1}}" @if(isset($offer) && $offer->detail->type == ($key+1))selected @endif">{{$type}}</option>
                                             @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="" id="offer_value" class="form-control" value="@if(isset($offer)){{$offer->detail->value}} @else 5 @endif">
                                    </div>
                                </div>
