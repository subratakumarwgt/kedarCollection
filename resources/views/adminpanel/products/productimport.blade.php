					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-3">
							<div class="mb-3 mt-1  shadow">
								<img src="{{asset('assets/images/product/1.png')}}" class="img-thumbnail" id="img_prv">
							</div>
						</div>
						<div class="col-md-9">
						...
						<form class="row" id="product_form_2">
							...
							<div class="col-md-12 mb-3">
								<div>
									...
									<textarea class="form-control" rows="4" placeholder="Enter About your description" required id="description"></textarea>
								</div>
							</div>
							<div class="row">							
								<div class="col-md-6">
									<button class="btn btn-block btn-success " id="submit"><i class="fa fa-arrow-up"></i> Update product</button>
...
<script>
	...
	$("table").on("click", ".addRow", function() {
		$(this).closest("tr").before($(this).closest("tr").clone()).find(".addRow").replaceWith(`<button class="btn btn-sm btn-danger removeRow btn-pill"><i class="fa fa-minus-circle"></i></button>`)
	})
	...
	$(".modal-content").on("click", ".setData", function() {
		...
		tableData = tableData.filter((value,index)=>{
			return (value.quantity != "" || value.quantity != null || value.price != "" || value.price != null)
		})
	...
	$(".modal-content").on("click", ".setVariant", function() {
		...
		tableData = tableData.filter((value,index)=>{
			return (value.varient_id != "" || value.varient_id != null || value.variant_value_list.length != 0 || value.variant_value_list != null)
		})
		// console.log("tabledata", tableData)
