...
<div class="container-fluid">
  ...
  <div class="card-header">
		<div class="col-md-6">
			...
			<input type="text" class="form-control" name="variant_name" class="variant_name" id="variant_name" value="{{@$variant->name}}">
		</div>
	...
	<table class="table">
		...
		<tbody class="addVariantBody">		
			@if(isset($variant))
            @foreach($variant->variantValues as $key => $value)	
            <tr class="price_row border-bottom">
				<td class="text-center"> <input type="text" class="form-control variant_label col-md-10" value="{{$value->value}}"></td>
				<td class="text-center"> <input type="text" class="form-control variant_value col-md-10" value="{{$value->label}}"></td>
				<td class="text-center"><input type="hidden" class="image_path" value="{{$value->image}}"><small class="text-primary statusText"></small> <input type="file" class="form-control variant_image productImage"></td>
				<td class="text-center">
					<div class="p-2 m-1 border"><img src="/{{$value->image}}" width="70px" height="70px" alt="" class="img-fluid image-preview"></div>
				</td>
