                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" placeholder="Name" data-bs-original-title="" id="name" required value="{{@$emailTemplate->name}}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="" id="text-box-body" class="form-control" rows="6" value="{{@$emailTemplate->body}}">{{@$emailTemplate->body}}</textarea>
                                    </div>
                                </div>
